...
| <code>[<br>&nbsp;&nbsp;TextStylerRule(start="*", transform=html_tag("strong")),<br>&nbsp;&nbsp;TextStylerRule(start="_", transform=html_tag("em"))<br>]</code>  | my \*bolded and \_italicized\_ text\*                                                                                                      | My <strong>bolded and <em>italicized</em> text</strong>                                                                                                              |
